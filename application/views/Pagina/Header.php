            ...
            <div class="collapse navbar-collapse justify-content-md-center" id="menu">
                <ul class="navbar-nav mr-center">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle ml-3 " id="menuJornalista" data-toggle="dropdown">Categorias</a>
                        <div class="dropdown-menu" aria-labelledby="menuJornalista">
                            <?php
                            foreach ($categorias as $c) {
                                echo '<a class="dropdown-item" href="' . $this->config->base_url() . 'Pagina/vizualizarCategoria/' . $c->id . '">' . $c->nome . '</a>';
                            }
                            ?>
                        </div>
                    </li>
            ...
            <ul class="navbar-nav justify-content-end">
                <li class="nav-item">
                    <a class="nav-link" href="<?= $this->config->base_url() . 'Jornalista/sair' ?>">
                        <i class="far fa-user mr-2"></i>Jornalistas
                    </a>
                </li>
            </ul>
        </nav>