...
<div class="container">
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" >
                    ...
                    <div class=" text-center carousel-item <?=$x==1?'active':null?>">
                        <a href="http://127.0.0.1/ProjetoIntegrador/Pagina/vizualizar/<?= $n->id?>"><img  src="<?=base_url('/uploads/' . $n->imagem)?>" class="d-block w-100 col-12" style="max-width: 768px; object-fit: cover; min-width: 768px; max-height: 400px; min-height: 400px; " alt="<?=$n->titulo?>"></a>
                        <div class="carousel-caption d-none d-md-block">
                            <a class="text-light"  style="font-weight: bold;" href="<?= $this->config->base_url() . 'Pagina/vizualizarCategoria/' . $n->cd_categoria  ?>"><?=$n->nomecategoria?></a>
    ...
    <div class="card-title text-center"><h2 style="color: #F8094E;"><a style="color: #F8094E;" href="<?= $this->config->base_url() . 'Pagina/vizualizarCategoria/4' ?>"><i class="fas fa-gamepad"></i> E-SPORTS </a></h2></div>
    ...
    <div class="card-title text-center"><h2 style="color: #267700;"><a style="color: #267700;" href="<?= $this->config->base_url() . 'Pagina/vizualizarCategoria/1' ?>"><i class="fas fa-futbol"></i> ESPORTES</a></h2></div>
    <div class="row mt-5 offset-md-1">
        ...
        echo '<div class="card mb-4 col-5 mr-5" style="min-height: 150px;" >';
            echo '<div class="row no-gutters">';
                echo '<div class="col-md-4"';  
                    echo '<a href="'. $this->config->base_url() . 'Pagina/vizualizar/'. $es->id . '"><img src="' . base_url('/uploads/'. $e->imagem). '" class="card-img  align-middle rounded mt-4" alt="" style="max-width: 140px; min-width:140px; object-fit: cover; max-height: 100px; min-height: 100px;"></a>';
                echo '</div>';
                echo '<div class="col-md-8">';
                    echo '<div class="card-body">';
                    //echo '<p class="text-muted">'.$es->data.' | '.$es->hora.'</p>';
