                ...
                <div class="col-8 offset-md-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="id" value="<?= (isset($categoria)) ? $categoria->nome : ''; ?>">
                                <div>
                                    <div>
                                        <label for="nome"> Nome: </label>
                                        <input type="text" name="nome" id="nome" class="form-control" value="<?= (isset($categoria)) ? $categoria->nome : ''; ?>">
                                        <br><br>
